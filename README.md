...
| `.mpc` | Musepack SV7 / SV8 | APEv2 | ✔ | ✔ |
| `.tta` | TTA | APEv2 | ✔ | ✔ |
| `.tak` | TAK | APEv2 | ✔ | ✔ |
| `.ofr` `.off` `.ofs` | OptimFROG Lossless / Float / DualStream | APEv2 | ✔ | ✔ |
...
| `.mka` `.mkv` | Matroska | EBML tags, chapters, and image attachments | ✔ | ✔ |
| `.weba` `.webm` | WebM | EBML tags and chapters | ✔ | ✔ |
...
- **MusicFileUtilities** — the core library. Per-format binary parsers (`ID3.cs`, `FLAC.cs`,
  ...
  `MonkeysAudio.cs`, `ApeV2Formats.cs`, `Asf.cs`, `Matroska.cs`) behind common interfaces:
